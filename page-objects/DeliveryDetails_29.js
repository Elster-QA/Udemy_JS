...
export class DeliveryDetails {
    constructor(page) {
        ...
        this.discountFrame = page.frameLocator('[data-qa="active-discount-container"]')
    ...
    continueToPayment = async () => {
        ...
        const discountCode = await this.discountFrame.innerText()
        ...
        await expect(this.dicountDone).toBeVisible()
